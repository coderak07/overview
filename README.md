<h1 align="center">👋 Hi, I'm <a href="www.linkedin.com/in/dev-akshaykate" target="_blank"> Akshay Kate </a> </h1>
...
<table>
  <tr>
    <td><img src="
      ...
      >
        <title id="titleId">Prakash Naikwadi's GitHub Stats, Rank: A+</title>
        <desc id="descId">Total Stars Earned: 14, Total Commits in 2022 : 14, Total PRs: 5, Total Issues: 2, Contributed to (last year): 2</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 125.02088125907116;
      }
    }
    ...
    @keyframes fadeInAnimation {
      ...
      <text
        ...
        class="header"
        data-testid="header"
      >Prakash Naikwadi's GitHub Stats</text>
    </g>
      </g>
